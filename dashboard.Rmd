...
Below we clean the data, creating separate variables for year, month, and day and converting `tmax` and `tmin` to numeric. We will work on observations with id "USC00300023", "USC00301152", and "USC00304912" in 2001 without NAs.
```{r}
weather_df = 
  ny_noaa %>% 
  na.omit() |> 
