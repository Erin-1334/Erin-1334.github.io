...
Below we clean the data, creating separate variables for year, month, and day and converting `tmax` and `tmin` to numeric. We will work on observations in 2001 without NAs.
```{r}
weather_df = 
  ny_noaa %>% 
  na.omit() |> 
